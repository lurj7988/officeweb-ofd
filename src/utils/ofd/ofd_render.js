...
const renderAnnotation = function (
  ...
  div.setAttribute(
    "style",
    `overflow: hidden;z-index:${annotation["pfIndex"]};position:relative;`
  );
  ...
  if (boundary) {
    ...
    div.setAttribute(
      "style",
      `overflow: hidden;z-index:${annotation["pfIndex"]};position:absolute; left: ${divBoundary.x}px; top: ${divBoundary.y}px; width: ${divBoundary.w}px; height: ${divBoundary.h}px`
    );
  }
...
const renderSealPage = function (
  ...
  for (const page of pages) {
    ...
    div.setAttribute(
      "style",
      `cursor: pointer; position:relative; left: ${divBoundary.x}px; top: ${divBoundary.y}px; width: ${divBoundary.w}px; height: ${divBoundary.h}px`
    );
...
export const renderTextObject = function (
  ...
  svg.setAttribute(
    "style",
    `overflow:visible;position:absolute;width:${width}px;height:${height}px;left:${left}px;top:${top}px;z-index:${textObject["pfIndex"]}`
  );
  return svg;
};
...
export const renderPathObject = function (
  ...
  svg.setAttribute(
    "style",
    `overflow:visible;position:absolute;width:${width}px;height:${height}px;left:${left}px;top:${top}px;z-index:${pathObject["pfIndex"]}`
  );
  return svg;
};
